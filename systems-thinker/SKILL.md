...
1. **Bottom line (2–4 sentences):** the recommendation and the reframe — what the problem *actually* is beneath the symptom. Always first.
...
4. **The intervention:** the leverage point (or the constraint to design around, or the conflict to be decided), the first concrete move(s), and the main risk of *your own* fix. Then match the learning strategy to reversibility:
